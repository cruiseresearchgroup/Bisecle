...
def get_args_parser():
    ...
    # paramerters for contrastive loss
    parser.add_argument('--negative_sample_size', type=int, default=4,
                        help='Number of negative question types to sample')
    parser.add_argument('--neg_temp', type=float, default=0.5,
                        help='Temperature for negative guidance')
    parser.add_argument('--tqcp_weight', type=float, default=1,
