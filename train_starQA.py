...
def get_args_parser():
    ...
    parser.add_argument('--max_seq_len', type=int, default=180, metavar='LENGTH', help='the maximum sequence length')
    ...
    parser.add_argument('--output_dir', default='./checkpoint/star', help='path where to save, empty for no saving')
    ...
    parser.add_argument('--negative_sample_size', type=int, default=2,
...
def main(args):
    ...
    qn_types = ['Interaction','Sequence','Prediction','Feasibility']
    processed_type = []
    ...
    for type in qn_types:
        ...
        for epoch in range(args.start_epoch, args.epochs):
            ...
            for i in range(len(processed_type)):
                ...
                val_stats = val_one_epoch(model_without_ddp, data_loader_val, optimizer, epoch, args=args, task_type=type)
